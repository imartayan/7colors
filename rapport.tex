...
\begin{Tab}
    \begin{BTab}[1]{LCCCCC}
        ...
        hégémonique SB & 539 V / 453 D & 583 V / 411 D & -- & 704 V / 291 D & 749 V / 241 D\\
        hybride & 276 V / 720 D & 343 V / 651 D & 291 V / 704 D & -- & 573 V / 415 D\\
        hybride SB & 225 V / 772 D & 307 V / 687 D & 241 V / 749 D & 415 V / 573 D & --
    \end{BTab}
    \caption{Résultats de 1000 parties entre les joueurs artificiels}
\end{Tab}
...
\begin{Tab}
    \begin{BTab}[0.75]{LCCC}
        \hspace{1.5cm} joueur opposant & hybride SB & Harpagon & MiniMix\|
        hybride SB & -- & 554 V / 435 D & 782 V / 211 D\\
        Harpagon & 435 V / 554 D & -- & ? V / ? D\\
        MiniMix & 211 V / 782 D & ? V / ? D & --
    \end{BTab}
    \caption{Résultats de 1000 parties entre les joueurs artificiels}
\end{Tab}
